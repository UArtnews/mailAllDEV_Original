    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Article Cart
                    <small>&nbsp;&nbsp;Articles ready for inclusion in a publication.</small>
                </h4>
            </div>
            <div class="modal-body">
                ...
                <ul id="cartList" class="list-group">
                    ...
                    <li class="list-group-item cartItem"><a
                            href="{{ URL::to('edit/'.$instance->name.'/articles/'.$article_id) }}">{{ $title }}</a>&nbsp;&nbsp;
                        <button class="btn btn-xs btn-danger" onclick="removeArticleFromCart({{ $article_id }})">Remove
                            from cart
                        </button>
                    </li>
                    @endforeach
        ...
        <div class="panel panel-default colorPanel">
            ...
            <div class="panel-body" id="livePublicationBody">
                <div class="contentDiv" id="publication{{ $publication->id }}">
                    ...
                    {{ isset($tweakables['publication-footer']) ? $tweakables['publication-footer'] :
                    $default_tweakables['publication-footer'] }}
                </div>
            </div>
...
<div class="row" style="text-align:center;color:white;">
    <a href="{{URL::to('/')}}  ">Publication List</a> | <a href="{{ URL::to($instance->name) }}">Live Publication
        View</a>
</div>
</body>
</html>